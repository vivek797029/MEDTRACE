...
code([
    ...
    "NUM_HOSPITALS = 3\n",
    "FL_ROUNDS = 10            # 10 rounds for ~10 hours training on T4\n",
    "LOCAL_EPOCHS = 2           # 2 epochs per hospital per round\n",
    "SAMPLES_PER_HOSPITAL = 1500  # 1500 samples per hospital per round\n",
    "LORA_R = 8\n",
    "LORA_ALPHA = 16\n",
    "BATCH_SIZE = 4\n",
    "MAX_LENGTH = 512\n",
    ...
    "              'Generate step-by-step auditable diagnostic reasoning chains.')\n",
    "\n",
    "HOSPITAL_CONFIGS = {\n",
    "    'hospital_A': {'name': 'Metro General (Cardiology)', 'kw': ['heart','cardiac','coronary','chest pain','myocardial'], 'samples': SAMPLES_PER_HOSPITAL},\n",
    "    'hospital_B': {'name': 'Royal London (Neurology)',   'kw': ['brain','neuro','seizure','headache','stroke'], 'samples': SAMPLES_PER_HOSPITAL},\n",
    "    'hospital_C': {'name': 'AIIMS Delhi (Infectious)',   'kw': ['infection','fever','bacteria','virus','antibiotic'], 'samples': SAMPLES_PER_HOSPITAL},\n",
    "}\n",
    "\n",
...
code([
    ...
    "        out_dir = f'/content/fl_temp/{self.hospital_id}/round_{round_num}'\n",
...
code([
    ...
    "    # also write last completed round\n",
    ...
    "    updates = {}\n",
    "    for hid, client in hospitals.items():\n",
    "        w, m = client.train_local(global_w, r)\n",
    "        updates[hid] = (w, m)\n",
    "    global_w = server.aggregate(updates, r)\n",
    "    save_checkpoint(global_w, r)  # save after every round\n",
    "\n",
